/* CPP program for analyzing serial music. P49. */
...
class Dodecaphonic {
    ...
    int get(int index) { // get & set notes
...
/* define the operations. All of them return a Dodecaphonic object */
...
int main(int argc, char** argv) {
	...
	for (n = 0; n < 12; n++) { /* init row object */
		row.set(atoi(argv[n+2]), n);
	}

	switch(argv[1][1]) {
	case 'o': /* original transpose */
